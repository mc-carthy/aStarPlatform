...
public class BspGridLeaf {
    ...
    public BspGridLeaf (int _x, int _y, int _width, int _height, BspGridLeaf _parent)
    {
        x = _x;
        y = _y;
        width = _width;
    ...
    public bool Split ()
    {
        ...
        if (splitH)
        {
            firstChild = new BspGridLeaf (x, y, width, split, this);
            secondChild = new BspGridLeaf (x, y + split, width, height - split, this);
        }
        else
        {
            firstChild = new BspGridLeaf (x, y, split, height, this);
            secondChild = new BspGridLeaf (x + split, y, width - split, height, this);
        }
    ...
    public class Room {
        ...
        public Room (Vector2 _size, Vector2 _pos, BspGridLeaf _parent)
        {
            size = _size;
            pos = _pos;
            parent = _parent;
